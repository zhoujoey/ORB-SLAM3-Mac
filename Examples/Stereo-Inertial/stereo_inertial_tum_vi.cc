...
int main(int argc, char **argv)
{
    ...
    ORB_SLAM2::System SLAM(argv[1],argv[2],ORB_SLAM2::System::IMU_STEREO, true, 0, file_name);
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            if(ni>0)
            {
                ...
                {
                    // vImuMeas.push_back(ORB_SLAM2::IMU::Point(vAcc[first_imu],vGyro[first_imu],vTimestampsImu[first_imu]));
